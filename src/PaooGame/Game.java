...
import static PaooGame.States.State.LoadGame;
import static PaooGame.UI.Music.InitMusic;
import static PaooGame.UI.Sound.InitSound;
...
public class Game implements Runnable
{
    ...
    private State optionsState;        /*!< Referinta catre optiuni.*/
    private State pauseState;           /*!< Referinta catre pauza.*/
    private State difficultyState;           /*!< Referinta catre dificultate.*/
    ...
    private RefElem refLink;           /*!< Referinta catre un obiect a carui sarcina este doar de a retine diverse referinte pentru a fi usor accesibile.*/

    public static boolean audio;        /*!< Variabila cu ajutorul careia se face switch(on/off) la muzica.*/
    ...
    /*! \fn public State continueGame()
       \brief Functia de continuarea a unui joc precedent.
    */
    public State continueGame()
    {
        LoadGame();
        playState=new PlayState(refLink);
        refLink.GetKeyManager().keys[KeyEvent.VK_LEFT]=false;
        ...
        if(refLink.GetGame().level==1){
            PlayState.mapKEY=0;}
        else  if(refLink.GetGame().level==2){
            PlayState.treasureKEY=0;
        }else {PlayState.treasure=0;}
     ...
     */
    private void Update() throws ZeroException {
    ...
    /*! \fn public State getOptionsState()
        \brief Returneaza obiectul de tip option.
     */
    ...
    /*! \fn public State getLeaderboardState()
        \brief Returneaza obiectul de tip option.
     */
    public State getLeaderboardState()
    {
        return scoreState;
    }

    /*! \fn public State getLoadState()
        \brief Returneaza obiectul de tip load.
     */
    public State getDifficultyState()
    {
  ...
  */
    ...
    /*! \fn  public static Game getInstance()
        ...
        Astfel ne asiguram ca jocul este instantiat o singura data.(Modelul Singleton)
     */
    public static Game getInstance()
    {
        if(instance==null)
            instance=new Game("The Lost Treasure", 1200, 720);
        return instance;
    }
