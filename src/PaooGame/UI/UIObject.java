...
public abstract class UIObject {
    ...
    protected boolean isON =false;  /*!< Variabila de verificare daca se afla cursorul pe buton.*/
    ...
    */
    ...
    /*! \fn  public abstract void Draw(Graphics g)
        ...
        \param g Contextul grafic in care trebuie sa deseneze enitate  pe ecran.
     */
    ...
    public void onMouseMove(MouseEvent e){
        isON = bounds.contains(e.getX(), e.getY());
    }
