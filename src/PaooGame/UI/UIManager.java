...
public class UIManager {
    private RefElem handler;               /*!< Referinta catre un obiect ce retine diverse referinte pentru a fi usor accesibile.*/
    private ArrayList<UIObject> objects;    /*!< Referinta catre un array de butoane.*/

    /*! \fn public  UIManager(RefElem handler)
        \brief Constructorul de initializare al clasei.
        \param handler RefElem UIManager.
    */
    public UIManager(RefElem handler)
    {
