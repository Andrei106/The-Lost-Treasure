...
/*! \class public class TreasureKey extends StaticEntity
\brief Defineste notiunea de cheie pentru a putea trece la nivelul urmator.
*/
public class TreasureKey extends StaticEntity {
public int id = 44; /*!< Referinta catre id.*/

/*! \fn public TreasureKey(RefElem handler, float x, float y)
 ...
 */
public TreasureKey(RefElem handler, float x, float y) {
...
/*! \fn public void Draw(Graphics g)
    \brief  Deseneaza cheia de tip cheia comorii pe ecran.
