...
import java.awt.*;
    ...
    /*! \class public class MapKey extends StaticEntity
        \brief Defineste notiunea de cheie pentru a putea trece la nivelul urmator.
     */
public class MapKey extends StaticEntity {
    public int id = 33; /*!< Referinta catre id.*/

    /*! \fn public MapKey(RefElem handler, float x, float y)
     ...
     */
    public MapKey(RefElem handler, float x, float y) {
    ...
    /*! \fn public void Draw(Graphics g)
        \brief  Deseneaza cheia de tip harta pe ecran.
